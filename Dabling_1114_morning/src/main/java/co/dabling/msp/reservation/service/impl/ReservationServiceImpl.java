...
public class ReservationServiceImpl implements ReservationService {
	...
	@Override
	public List<ReservationVO> storeReservationListSearch(int storeCode, String firstDate, String lastDate) {
		return map.storeReservationListSearch(storeCode, firstDate, lastDate);
	}
