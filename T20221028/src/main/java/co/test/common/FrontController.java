...
public class FrontController extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		map.put("/SearchBookFormControl.do", new SearchBookFormControl());
		map.put("/searchBook.do", new SearchBookControl());

		map.put("/ModifyBookFormControl.do", new ModifyBookFormControl());
		map.put("/modifyBook.do", new ModifyBookControl());

		map.put("/RemoveBookFormControl.do", new RemoveBookFormControl());
		map.put("/RemoveBook.do", new RemoveBookControl());

		map.put("/ListBookControl.do", new ListBookControl());
	}
