				...
				<div class="col-12">
					<nav class="main-nav">
						...
						<ul class="nav">
							...
							<li class="scroll-to-section"><a href="logout.do">Logout</a></li>
                        ...
                        -->
							...
							<li class="submenu"><a href="javascript:;">Mypage</a>
								<ul>
									<c:if test="${author == '1'}">
										<li><a href="#">---일반회원---</a></li>
										...
										<li><a href="history.do">이용내역</a></li>
										<li><a href="review.do">리뷰게시판</a></li>
									</c:if>
									<c:if test="${author == '2'}">
							...
							<li class="scroll-to-section"><a href="#reservation">Contact
									Us</a></li>
						</ul>
